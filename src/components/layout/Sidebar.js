...
const Sidebar = () => {
  ...
  const allNavItems = [
    ...
    { name: t('khataLedger'),    path: '/ledger',           icon: <FileText size={20} />,   roles: ['admin', 'manager', 'cashier'] },
    { name: t('collectPayment'), path: '/collect-payment',  icon: <DollarSign size={20} />, roles: ['admin', 'manager', 'cashier'] },
